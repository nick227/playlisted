...
export function TitleIntroVisual({
  ...
  return (
    <div className="focus-lane__title-intro mx-auto flex min-w-0 items-center gap-3 rounded-2xl border border-white/10 bg-black/50 p-3 shadow-2xl backdrop-blur-xl transition-all sm:gap-5 sm:rounded-3xl sm:p-4">
      {imageUrl ? (
