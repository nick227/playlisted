...
export type MuseumGridKind = "songs" | "artists" | "playlists";
...
export type MuseumExhibit =
  ...
  | { id: string; kind: "artist-feature"; artist: LibraryArtist; songs: LibrarySong[] }
  ...
  | { id: string; kind: "listening-room"; playlist: PlaylistSummary };
