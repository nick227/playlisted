...
function EmbeddedRadioFallback() {
  return (
    ...
    >
      <div className="mx-auto flex h-full min-h-0 w-[min(100%,30rem)] shrink-0 flex-col items-center justify-between gap-2 sm:justify-center sm:gap-0">
        ...
        <div className="grid w-full shrink-0 grid-cols-1 justify-items-stretch px-4 text-center sm:mt-7 sm:min-h-[9.35rem]">
          <div className="mb-1 h-5 w-36 justify-self-center rounded-full bg-white/[0.035] sm:mb-3" />
          <div className="h-[4.9rem] w-full rounded-sm bg-white/[0.04]" />
          <div className="mt-1 h-7 w-52 justify-self-center rounded-sm bg-white/[0.035] sm:mt-3" />
        </div>
