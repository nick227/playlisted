import type { LiminalRoom, RoomGenerationOptions, SceneType, WatchBudget } from '../core/types'
...
export function generateRoom(
  ...
  // castType is picked from a different salt so it varies independently.
  // Occasionally they match (pure coincidence), but usually you get a
  // venue with a crowd that doesn't "belong" there — that's the point.
  const castType = pickSceneType(resolved.seed, index + 997)
