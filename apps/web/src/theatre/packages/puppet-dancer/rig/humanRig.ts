...
export const humanRig: PuppetRig = {
  ...
  joints: [
    ...
    { id: 'leftElbow', parent: 'leftShoulder', length: 42, angle: 124, radius: 7 },
    { id: 'leftWrist', parent: 'leftElbow', length: 38, angle: 88, radius: 7 },
    { id: 'rightShoulder', parent: 'chest', length: 24, angle: -10, radius: 8 },
    { id: 'rightElbow', parent: 'rightShoulder', length: 42, angle: -56, radius: 7 },
    { id: 'rightWrist', parent: 'rightElbow', length: 38, angle: -88, radius: 7 },
